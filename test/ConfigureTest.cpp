...
TEST_CASE("Configure", "[Configure]") {
  SECTION("Project Version Info") {
    FINFO_MSG("Project Version Info");
    ...
    FINFO("PROJECT_NAME:{}", PROJECT_NAME);
    FINFO("PROJECT_VERSION:{}", PROJECT_VERSION);
    FINFO("PROJECT_VERSION_MAJOR:{}", PROJECT_VERSION_MAJOR);
    FINFO("PROJECT_VERSION_MINOR:{}", PROJECT_VERSION_MINOR);
    FINFO("PROJECT_VERSION_PATCH:{}", PROJECT_VERSION_PATCH);
  }
}
