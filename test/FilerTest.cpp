...
TEST_CASE("Filer", "[Filer]") {
  SECTION("read/write") {
    icu::UnicodeString text1 = UNICODE_STRING_SIMPLE(
        ...
        "the whole text.\n");
    int n1 =
        fastype::Filer::write(UNICODE_STRING_SIMPLE("FilerTest1.log"), text1);
    REQUIRE(n1 == text1.length());
    icu::UnicodeString result1 =
        fastype::Filer::read(UNICODE_STRING_SIMPLE("FilerTest1.log"));
    ...
    int n2 =
        fastype::Filer::write(UNICODE_STRING_SIMPLE("FilerTest2.log"), text2);
    REQUIRE(n2 == text2.length());
    icu::UnicodeString result1 =
        fastype::Filer::read(UNICODE_STRING_SIMPLE("FilerTest2.log"));
  ...
  SECTION("append/readline") {
    ...
    int n1 =
        fastype::Filer::append(UNICODE_STRING_SIMPLE("FilerTest3.log"), l1);
    int n2 =
        fastype::Filer::append(UNICODE_STRING_SIMPLE("FilerTest3.log"), l2);
    int n3 =
        fastype::Filer::append(UNICODE_STRING_SIMPLE("FilerTest3.log"), l3);
    int n4 =
        fastype::Filer::append(UNICODE_STRING_SIMPLE("FilerTest3.log"), l4);
    ...
    std::vector<icu::UnicodeString> lines =
        fastype::Filer::readline(UNICODE_STRING_SIMPLE("FilerTest3.log"));
