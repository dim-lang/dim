...
TEST_CASE("NameGenerator", "[NameGenerator]") {
  ...
  SECTION("Ir Name Generator") {
    ...
    REQUIRE(irgen.generate("a").substr(0, 9) == std::string("shp.ir.a."));
    REQUIRE(irgen.generate("a", "b").substr(0, 11) ==
            std::string("shp.ir.a.b."));
    REQUIRE(irgen.generate("a", "b", 1, 2.3).substr(0, 17) ==
            std::string("shp.ir.a.b.1.2.3."));
    REQUIRE(irgen.generateWith("c", "d").substr(0, 11) ==
            std::string("shp.ir.c.d."));
    REQUIRE(irgen.generateWith("c", "d", 4, 5.6).substr(0, 17) ==
