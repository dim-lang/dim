...
echo [rec] prepare boostorg/boost %BOOST_VERSION% - done
echo [rec] prepare llvm/llvm-project %LLVM_VERSION%
...
echo [rec] prepare llvm/llvm-project %LLVM_VERSION% - done
